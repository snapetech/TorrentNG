...
| Remaining field depth | detailed availability depth, tracker delta internals, live webseed activity, and native-backed effects for script/blocklist/preferred transport settings | Gap or compatibility placeholder; qBit, Transmission, and Deluge now project peer counters/rates from native snapshots where available |
