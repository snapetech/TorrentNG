...
- [x] Add basic Linux `UringBackend` for positioned read/write/data-sync SQEs.
- [ ] Extend `UringBackend` with registered fds + fixed buffers + batched submit/completion.
