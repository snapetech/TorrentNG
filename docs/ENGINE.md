...
crates/
  ...
  rt-utp/             — uTP packet codec primitives (Phase 10)
...
- TCP listener
- uTP packet codec support; full socket transport remains behind the runtime
  capability `networking.utp_transport=false`
