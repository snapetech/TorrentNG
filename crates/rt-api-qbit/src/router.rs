...
fn qbit_routes() -> Router<AppState> {
    Router::new()
        ...
        .route("/rss/addFolder", post(rss_noop))
        .route("/rss/addFeed", post(rss_noop))
        .route("/rss/removeItem", post(rss_noop))
        .route("/rss/moveItem", post(rss_noop))
        .route("/rss/markAsRead", post(rss_noop))
        .route("/rss/refreshItem", post(rss_noop))
        .route("/rss/setRule", post(rss_noop))
        .route("/rss/renameRule", post(rss_noop))
        .route("/rss/removeRule", post(rss_noop))
}
