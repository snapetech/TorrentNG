...
That selects tinyxml2 XMLRPC handling for the known-good bundle. The host helper mirrors the Docker build flow: run `autoreconf -fi`, build matching rTorrent/libtorrent tags, and apply the rtorrentNG user-agent XMLRPC patch when available.
