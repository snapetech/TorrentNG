...
RTNG_INCOMING_PORT="${RTNG_INCOMING_PORT:-51000}" \
...
echo "rtorrentNG certification service restored with RTNG_SYNC_INTERVAL_SECS=2"
echo "URL: http://localhost:${RTNG_HOST_PORT:-28080}"
