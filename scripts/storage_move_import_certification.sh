...

{
  ...
  echo "## Notes"
  echo
  echo "- Covers symlink-safe no-overwrite move execution, copy-based move source cleanup after verified rename, hardlink-or-copy import, recursive directory copy verification, rename/copy/import symlink rejection, symlink-safe delete, staged rollback cleanup, approved directory delete, and storage-root confinement."
