...
metrics_promoted_latency_ms="not sampled"
promotion_hot="0"
...
echo "| Metrics request after promotion | ${metrics_promoted_latency_ms} ms |"
...
echo "| Restart metrics request | ${metrics_restart_latency_ms} ms |"
